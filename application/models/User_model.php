...
class User_model extends CI_Model {
	...
	{	
		$this->db->select('tbl_booking.*,tbl_booking_status.fk_status_id,pa_users.firstName,pa_users.lastName,tbl_status_master.status as booking_status,tbl_user_car_details.car_number,tbl_parking_place.place_name,tbl_parking_place.address,tbl_parking_place.pincode,tbl_states.name as state_name,tbl_cities.name as city_name,tbl_payment.total_amount,tbl_slot_info.display_id,tbl_parking_place.latitude,tbl_parking_place.longitude,tbl_extension_booking.booking_ext_replace,tbl_extension_booking.booking_from_date as ext_booking_from_date,tbl_extension_booking.booking_to_date as ext_booking_to_date,tbl_extension_booking.booking_from_time as ext_booking_from_time,tbl_extension_booking.booking_to_time as ext_booking_to_time,tbl_extension_booking.reserve_from_time as ext_reserve_from_time,tbl_extension_booking.reserve_to_time as ext_reserve_to_time,');
