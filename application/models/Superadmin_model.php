...
class Superadmin_model extends CI_Model {
    ...
    public function get_hour_price_slab($id='')
    {
        ...
        $this->db->select('GROUP_CONCAT(tbl_hours_price_slab.id) as id,GROUP_CONCAT(tbl_hours_price_slab.from_hours) as from_hours,GROUP_CONCAT(tbl_hours_price_slab.to_hours) as to_hours,GROUP_CONCAT(tbl_hours_price_slab.cost) as cost,GROUP_CONCAT(tbl_hours_price_slab.fk_currency_id) as fk_currency_id,tbl_hours_price_slab.fk_vehicle_type_id,tbl_vehicle_type.vehicle_type');
